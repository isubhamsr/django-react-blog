    ...
    render() {
        ...
        if (this.state.article === null) {
            ...
            return (
                ...
                <img src={"http://127.0.0.1:8000/media/" + this.state.article.article_image} class="img-fluid" alt="cover"></img>
                <hr class="my-4"/>
                <div class="blog-post my-4">
                    ...
                    <pre className="bg-dark text-white p-4"><code>Example code block</code></pre>
